...
from submodules import define_G,  ChannelAttentionv2, PatchEmbed, PatchUnEmbed, FusionSwinTransformerBlock
...
def mem_update(ops, x, mem, spike):
    ...
    return mem, spike
class Hybrid1031(nn.Module):
    def __init__(self):
        super(Hybrid1031, self).__init__()
